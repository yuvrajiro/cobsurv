...
copyright = f"2023-{current_year}, Rahul Goswami and Arabin Kumar Dey"
...
extlinks = {
    "issue": ("https://github.com/yuvrajiro/peoxasurv/issues/%s", "#%s"),
}
...
def linkcode_resolve(domain, info):
    ...
    if fn.startswith("sksurv/"):
        ...
        return "https://github.com/yuvrajiro/cobsurv/blob/{branch}/{filename}{linespec}".format(
...
class RTDUrlPreprocessor(Preprocessor):
    ...
    URL_PATTERN = re.compile(r"\(https://cobsurv\.readthedocs\.io/.+?/.+?/([-._a-zA-Z0-9/]+)/(.+?)\.html.*?\)")
